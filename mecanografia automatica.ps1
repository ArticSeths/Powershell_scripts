...
$fichero=’C:\Users\user\Documents\power\captura.png’
screenshot $bounds $fichero
cd ‘C:\Program Files (x86)\Tesseract-OCR’
$ficheroout=’C:\Users\user\Documents\power\captura’
...
#f kj asdf ñlkj asdf fj añsldkfj añsldkfj para: Lecclón 1 un MétodoResultados Data: Leocuón 1 1° Método 